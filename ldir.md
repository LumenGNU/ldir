...
- [ ] Поддерживаемые версии Python: 3.8 и выше.
...
- [ ] Утилита должна открывать содержимое указанного каталога в текстовом редакторе пользователя.
    ...
    - [ ] Формат ldir-файла.
- [ ] Каждый файл или директория в каталоге должны представляться отдельной строкой в текстовом редакторе.
...
ldir [options] <directory>
  ...
  --recursive   -r  Флаг, рекурсивно обрабатывать подкаталоги (False).
