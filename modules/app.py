...
class App:
    ...
    def cl_params(self) -> argparse.Namespace:
        ...
        Returns:
            ...
            - `depth`: `int` - Глубина обхода подкаталогов.
    ...
    def parse_args(self) -> argparse.Namespace:
        ...
        group_catalog.add_argument(
            ...
            type=int,
            dest="depth",
            help="Флаг, рекурсивно обрабатывать подкаталоги (False). Если указано число, то обрабатывать до указанной"
            "глубины, 0 -- только текущая директория, отрицательное число -- обработать на всю глубину",
        )
        group_catalog.add_argument(
            "-d",
            "--directory",
